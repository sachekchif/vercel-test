...
const AdminRequest = () => {
  ...
  }, [pendingRefetch, completeRefetch, rejectedRefetch, inReviewRefetch]);
        ...
        if (record.status === "pending") {
          return (
            <button
              ...
              // className="bg-gray-800 hover:bg-black text-white font-medium rounded border-none hover:border-gray-800 hover:border-2 items-center justify-center flex px-2 py-1"
              className={`text-white font-medium rounded border-none items-center justify-center flex px-2 py-1 ${
                updatingRequestId === record.id
                  ? "bg-gray-300 border-gray-500 text-gray-500 cursor-not-allowed"
                  : "bg-gray-800 hover:bg-black   hover:border-gray-800 hover:border-2 "
              }`}
          ...
          return (
            <button
              ...
              className="bg-gray-200 text-gray-500 border-gray-500 border-1 rounded font-normal items-center justify-center flex px-2 py-1"
            >
              Treating...
            </button>
          );
      ...
      render: (text, record) => {
        ...
        return (
          <div className="flex items-center justify-start">
            ...
            (userData?.profile?.firstName + " " + userData?.profile?.lastName ) === record?.reveiwedByName ? (
              <button
